...
class Auth extends ShieldAuth
{
    ...
    */
    ...
    public array $tables = [
        'users'             => 'ci4_users',
        'identities'        => 'ci4_auth_identities',
        'logins'            => 'ci4_auth_logins',
        'token_logins'      => 'ci4_auth_token_logins',
        'remember_tokens'   => 'ci4_auth_remember_tokens',
        'groups_users'      => 'ci4_auth_groups_users',
        'permissions_users' => 'ci4_auth_permissions_users',
    ];
